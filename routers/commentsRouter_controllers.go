...
func init() {
	...
	beego.GlobalControllerRouter["github.com/udistrital/experiencia_laboral_crud/controllers:DatoAdicionalTipoExperienciaLaboralController"] = append(beego.GlobalControllerRouter["github.com/udistrital/experiencia_laboral_crud/controllers:DatoAdicionalTipoExperienciaLaboralController"],
		beego.ControllerComments{
			Method:           "Post",
			Router:           `/`,
			AllowHTTPMethods: []string{"post"},
	...
	beego.GlobalControllerRouter["github.com/udistrital/experiencia_laboral_crud/controllers:TipoExperienciaLaboralController"] = append(beego.GlobalControllerRouter["github.com/udistrital/experiencia_laboral_crud/controllers:TipoExperienciaLaboralController"],
		beego.ControllerComments{
			Method:           "Post",
			Router:           `/`,
			AllowHTTPMethods: []string{"post"},
